...
fn basic_unique_index_must_work() {
    ...
    user_model.assert_has_index(IndexDefinition {
        ...
        fields: vec![IndexField::new_in_model("firstName"), IndexField::new_in_model("lastName")],
...
fn mapping_unique_to_a_field_name_should_work() {
    ...
    model.assert_has_index(IndexDefinition {
        ...
        fields: vec![IndexField::new_in_model("name"), IndexField::new_in_model("identification")],
        tpe: IndexType::Unique,
        defined_on_field: false,
        algorithm: None,
    });
